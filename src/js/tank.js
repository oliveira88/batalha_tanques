...
export class Tank {
  ...
  #getTankImg(color) {
    ...
    if (this.controlType == "DUMMY")
      ...
      img.src = "../assets/tank_dummy.png";
    // Image adapted from: https://freesvg.org/1528027543
    else img.src = "../assets/tank.png";
  ...
  #assessDamage(arenaBorders, tanks) {
    ...
    if (
      this.x < 0 ||
      this.y < 0 ||
      this.x > this.arenawidth ||
      this.y > this.arenaheight
    ) {
      this.score = 0;
    }
    return false;
  ...
  draw(ctx, color = "yellow") {
    ...
    if (this.score > 20) ctx.fillStyle = "black";
